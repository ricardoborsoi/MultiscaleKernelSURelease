% =========================================================================
% 
% This code contains the example with the Cuprite image in the following paper:
% 
...
% =========================================================================
% load Cuprite image
load('/home/ricardo/Documents/RESEARCH_PARENT/RESEARCH_PARENT_cloud/THINGS_WORKING(ED)/___HSIs/cuprite_ref.mat')
% load('/home/rborsoi/HSIs/cuprite_ref.mat')
...
Yim = reshape(x',Lines,Columns,L);
[nr,nc,L] = size(Yim);
r = x;



% load endmember matrix

% --------------------------------------------------------------
% Endmember initialization (VCA [1])
% [M0, V, U, Y_bar, endm_proj, Y_proj] = find_endm(Y,P,'vca');
load('DATA/M0_cuprite.mat')
M = M0;
...
% sigma2_epsi = (5e-4) * norm(r,'fro')^2/N; 
...
axes(ha(3));
title('Nontronite','interpreter','latex')
axes(ha(4));
title('Montmorillonite','interpreter','latex')
